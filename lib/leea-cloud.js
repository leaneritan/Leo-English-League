...
(function () {
  ...
  const api = {
    ...
    async deleteProgress() { return false; },
    async deleteProgressAll() { return false; }
  };
  ...
  api.deleteProgress = async function (homeworkId, storageKey) {
    const data = await run('deleteProgress', () => api.client
      .from('leea_progress')
      .delete()
      .eq('family_id', api.familyId)
      .eq('homework_id', homeworkId)
  ...
  api.deleteProgressAll = async function (homeworkId) {
    const data = await run('deleteProgressAll', () => api.client
      .from('leea_progress')
      .delete()
      .eq('family_id', api.familyId)
      .eq('homework_id', homeworkId));
